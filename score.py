...
def get_match(url):
    try:
        ...
        print("Error: File 'matches.json' not found.")
        matches = {"match": []}  # Initialize as an empty dictionary
    ...
    Soup = BeautifulSoup(Scorecard.text, "html.parser")
...
url = "https://www.cricbuzz.com/live-cricket-scorecard/75413/eng-vs-nz-1st-match-icc-cricket-world-cup-2023"
